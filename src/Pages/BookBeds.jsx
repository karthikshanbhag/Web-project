...
const BookBeds = () => {
	...
	const handleSubmit = async () => {
		setisLoading(true)
		const res2 = await getHospitalData(hosSel)
		setHospital(res2.Hospital)
		setTimeout(() => {
	...
	return (
		<main className='w-full flex flex-col justify-center '>
				...
				<div className='dropdowns flex flex-row lg:gap-24 justify-center items-center sm:flex-row sm:gap-10 md:flex-row md:gap-10'>
					<div className="relative inline-block text-center">
						<div className="sm:col-span-3">
							<div className="">
								<select id="ward" name="ward" autocomplete="ward" className="bg-white pl-4 block w-full rounded-md border py-2 px-4 text-gray-900 shadow-sm sm:max-w-xs sm:text-sm sm:leading-6 font-semibold">
					...
					<div className="relative inline-block text-center">
						<div className="sm:col-span-3">
							<div className="">
								<select id="ward" name="ward" autocomplete="ward" className="bg-white pl-4 block w-full rounded-md border py-2 px-4 text-gray-900 shadow-sm sm:max-w-xs sm:text-sm sm:leading-6 font-semibold" onChange={(e) => setDisSel(e.target.value)}>
					...
					<div className="relative inline-block text-center">
						<div className="sm:col-span-3">
							<div className="">
								<select id="hospital" name="hospital" autocomplete="ward" className="bg-white pl-4 block w-full rounded-md border py-2 px-4 text-gray-900 shadow-sm sm:max-w-xs sm:text-sm sm:leading-6 font-semibold" onChange={handleChangeHos}>
									<option className='px-4 font-semibold' selected>--- Select Hospital ---</option>
									{
										Object.entries(Hospitals).map((key, value) => {
											return (
												<option key={key} className='px-4 font-semibold' value={Hospitals[value]._id} onClick={handleChangeHos}>{Hospitals[value].name}</option>
											)
										})
									}
			...
			<div className='border-2 rounded-md mt-4 mx-6 py-6 pb-8 flex flex-col justify-center items-center'>
				...
				<div className='px-4'>
					{hosSel && Object.keys(Hospital).length !== 0 && setisLoading
						&& <div className='w-full'>
							<section className='mt-6 py-6'>
								<div className='grid grid-cols-3 gap-x-8 gap-y-4 px-4'>

									<div className="flex border-2 border-orange-500 rounded-md py-4 px-6">
										<div className='flex flex-grow flex-row'>
											<div className='m-2'>
												<img src='/bed2.png' alt='bed logo' width={70} height={70} />
											</div>
											<div className='pl-6'>
												<h2 className="title-font font-bold text-xl text-gray-900">Beds Booked</h2>
												<div className="inline-flex gap-6 pt-2 ">
                  ...
                  <span className='flex justify-end'><HiOutlineArrowNarrowRight size={20} color={"blue"} className="hover:cursor-pointer" /></span>
									...
									<div className="flex border-2 border-orange-500 rounded-md py-4 px-6">
										<div className='flex flex-grow flex-row'>
											...
											<div className='pl-6'>
												<h2 className="title-font font-bold text-xl text-gray-900">Beds Available</h2>
												<div className="inline-flex gap-6 pt-2 ">
													<div className="text-gray-500 text-base">
                  ...
                  <span className='flex justify-end'><HiOutlineArrowNarrowRight size={20} color={"blue"} className="hover:cursor-pointer" /></span>
									...
									<div className="flex border-2 border-orange-500 rounded-md py-4 px-6">
										<div className='flex flex-grow flex-row'>
											...
											<div className='pl-6'>
												<h2 className="title-font font-bold text-xl text-gray-900">Occupied</h2>
												<div className="inline-flex gap-6 pt-2 ">
													<div className="text-gray-500 text-base">
                  ...
                  <span className='flex justify-end'><HiOutlineArrowNarrowRight size={20} color={"blue"} className="hover:cursor-pointer" /></span>
							...
							<section className='mt-6 px-8 py-6 border-t-2'>
								<div className="overflow-hidden bg-white shadow sm:rounded-lg">
									<div className="px-4 py-5 sm:px-6">
										<h3 className="text-base font-semibold leading-6 text-gray-900">Hospital Information</h3>
									</div>
										...
										<dl>
											<div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
												...
												<dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
													{/* <span className="flex-grow">{Hospital.name}</span> */}
													{Hospital.name}
													{/* <span className="ml-4 flex-shrink-0">
														<button type="button" name="userName" className="bg-white rounded-md font-semibold text-purple-600 hover:text-purple-500 focus:outline-none ">Update</button>
													</span> */}
												</dd>
											</div>
                                ...
                                <dd className="mt-1 flex text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    <span className="flex-grow">Johnnny@email.com</span>
                                    <span className="ml-4 flex-shrink-0">
                                        <button type="button" name="userName" className="bg-white rounded-md font-semibold text-purple-600 hover:text-purple-500 focus:outline-none ">Update</button>
                                    </span>
                                </dd>
											...
											<div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
												...
												<dd className="mt-1 flex text-sm text-gray-900 sm:mt-0 sm:col-span-2">
													<span className="flex-grow">+91 9878675678</span>
													<span className="ml-4 flex-shrink-0">
														{/* <button type="button" name="userName" className="bg-white rounded-md font-semibold text-purple-600 hover:text-purple-500 focus:outline-none ">Update</button> */}
													</span>
												</dd>
                                ...
                                <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">4657****8976</dd>
                            </div> */}
							...
							<div className="flex justify-end mt-7 leading-relaxed w-full">
								<Link to={`/bookbed/hospital/${Hospital._id}`}><button className="inline-flex mr-16 text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded-md text-lg shadow-gray-400 shadow-lg">Book Bed Now</button></Link>
							</div>
						</div>
					}
				</div>
